			...
			<!-- Start upcoming-exibition Area -->
				...
				<div class="container">
					<div class="section-top-border">
						<h3 class="mb-30">Festival Budaya Batak 2018</h3>
						<div class="row">
							<div class="col-md-4">
								<img src="img/pesta.jpg" alt="Museum TB Silalahi" class="img-fluid" style="border-radius: 10px;">
							</div>
							<div class="col-md-8 mt-sm-20">
								<p> Dalam event Festival Danau Toba 2014 (FDT 2014) ini, TB SILALAHI CENTER (TBSC) bekerja sama dengan Pemerintah Kabupaten Toba Samosir, Pemerintah Provinsi Sumatera Utara bersama dengan Kementerian Pariwisata dan Ekonomi Kreatif RI dan juga berbagai pihak-pihak sponsor yang turut serta dalam membantu penyelenggaraan event Festival Danau Toba 2014 (FDT 2014) yang akan dimulai pada tanggal 17-21 September 2014 di Kabupaten Toba Samosir, Sumatera Utara.
</p>	
					</div>
					<div class="col-md-12 mt-sm-20">
						<p>Dalam FDT 2014 akan digelar berbagai pameran dan atraksi pentas budaya masyarakat Sumut dan juga sejumlah kegiatan lainnya seperti:
<ul>
<li>Lomba Solu Bolon Dragon (dragon boat)</li>
<li>Lake Toba’s World Drum Festival,</li>
<li>Lomba Renang Internasional dan Renang Rakyat,</li>
<li>Pertunjukan Budaya,</li>
<li>Lomba Menyanyi dan Panduan Suara,</li>
<li>Lomba Arung Jeram,</li>
<li>Fashion Show,</li>
<li>Seminar Pariwisata,</li>
<li>Pameran Pariwisata dan</li>
